...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		produtoRep.saveAll(Arrays.asList(p1,p2,p3, p4, p5, p6, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","miltonvieirasoutomaior17@gmail.com","3637383377",TipoCliente.PESSOAFISICA);
